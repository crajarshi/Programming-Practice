...
public class PalindromePartitioning {
    /**
     * All backtracking problems are composed by these three steps: choose,
     * explore, unchoose.
     ...
     * 5.Choose: In this problem, if the substring of s is palindrome, we add it into the step,
     * which means we choose this substring.
