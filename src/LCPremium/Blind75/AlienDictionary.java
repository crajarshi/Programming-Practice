...
public class AlienDictionary {
    /**
     * Pretty similar to Course Schedule problem (LC 210), the only difference
     * is that we need to build graph by comparing every consecutive pair of
     * strings firstly, and then doing topological sort for the graph to get the
     * result string
     */
    /*.*/
