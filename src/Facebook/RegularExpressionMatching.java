...
public class RegularExpressionMatching {
    ...
    public boolean isMatch(String text, String pattern) {
        /**
         * f there were no Kleene stars (the * wildcard character for regular expressions),
         * the problem would be easier - we simply check from left to right if each character of the text matches the pattern.
         ...
         and see if they match the rest of the pattern. A recursive solution is a straightforward way to represent this relationship.
