...
public class KClosestPointstoOrigin {
     ...
     * hen get the top k closest points. We can use the sort function and the code is very short.
     * <p>
     ...
     * Thus, the max heap is always maintain top K smallest elements from the
     * first one to current one. Once the size of the heap is over its
     * maximum capacity,
     ...
     * we will get an array that all elements smaller than the pivot are on the left side of the pivot and
     ...
     * meaning the all element on the left of the pivot are all proper candidates
     * but it is not adequate, we have to do the same thing on right side,
     * and vice versa. If the p is exactly equal to the K,
     * meaning that we've found the K-th position. Therefore,
